...
def plot_imputation_accuracy(r2,
                             single_sample=True,
                             aggregate=True,
                             save_fig=False,
                             save_name='imputation_corr_vs_af.png',
                             outdir='graphs/'):
    ...
    if single_sample:
        ...
        if aggregate:
            for df in r2:
                ...
                plt.plot(np.arange(1, df.shape[0] + 1),
                         df['corr'],
                         label=panel)
            plt.xticks(np.arange(1, r2[0].shape[0] + 1),
                       r2[0]['AF'],
                       rotation=45)
            ...
            plt.text(x=-1.5,
                     y=1.02,
                     s='Aggregated imputation accuracy ($r^2$)')
            plt.grid(alpha=0.5)
        else:
